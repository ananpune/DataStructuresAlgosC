...
int main(void)
{
  /*   // Q0
    ...
    a.  int     i = 0x89;
        short   s = i;
        Y  can be done as s has enough bytes to support int i
        
    b.  int     i = 0x89;
        short   s = 0;
        i = s;
		
		i has 4 bytes which can hold a 2 byte short
        Y  
    ...
    c.  double  d = 0.05;
        ...
        d = f;
        Y  
		enough bytes in double to hold the 0.0 float
    ...
    d.  double  d = 0.05;
        ...
        f = d;
        Y  
		enough bytes in float to hold a double
        
    e.  int     i = 0x89;
        char    c = 0;
        i = c;
          Y
			a char is stored as an int so it can be done  */
...
static char * returnReverseString(char  str0[])                             
{
	...
	//unsure why I couldn't get this one to work, spent hours on it
	int size = strlen(str0);
	int i;
	char * ptr = malloc(strlen(str0));
	char * ptr2 = ptr;
